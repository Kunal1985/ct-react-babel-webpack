			...
			<div className={classes.root}>
				...
				<Grid container justify="center" alignItems="center">
					{productList && productList.length > 1 ? 
							productList.map(function (currProduct) {
								if (!currProduct) {
									return ""
								}
								let currProductId = currProduct.id;
								currProduct = currProduct.masterData.current;
								currProduct.id = currProductId;
							...
							<Typography variant="h6" color="textPrimary">Seems this is your first visit, browse different products to fill this section!</Typography>
						)}
				</Grid>
			</div>
		);
